...
There is a publically available implementation at \url{https://github.com/steve-downey/view_maybe} based on the Ranges implementation in libstdc++. There are no particular implementation difficulties or tricks. The declarations are essentially what is quoted in the Wording section and the implementations are described as effects.
