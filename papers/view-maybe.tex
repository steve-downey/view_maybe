...
namespace views { inline constexpr @\unspec@ nullable = @\unspec@; }
...
class maybe_view : public ranges::view_interface<maybe_view<Value>> {
  ...
  public:
    ...
    } // NOTE --- specification of hidden friend?
...
\pnum
\tcode{nullable_view} is a range adaptor that produces a \libconcept{view} with cardinality 0 or 1. It adapts \libconcept{copyable} object types.
